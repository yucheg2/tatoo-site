...
const StorageItem = ({ _id, src, place, size, style, onDelete, price, isSelfMade }) => {
    return (
        <div className={ "container-srorage" + (isSelfMade ? "-selfmade" : "") + " rounded-3 d-flex p-2 mb-2 mx-3"}>
